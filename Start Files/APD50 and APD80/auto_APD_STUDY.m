...
function [APD50_vec, APD80_vec] = auto_APD_STUDY(start, endp, study, file_number,filename_pdf, AP_num,firstAP,lastAP)
    ...
    for b1 = 1: length(bin)
        for f1 = 1: length(freq)
            ...
            for i = 1 : length(start)
                ...
                [apdMap1, filtered2, AP_start_points ,AP_baselines, AP_end_points, AP_storage, APD_average] = apdMap_STUDY(data, start(i), endp(i),...
    ...
    for b1 = 1: length(bin)
        for f1 = 1: length(freq)
            ...
            for i = 1: length(start)
                ...
                [apdMap1, filtered2, AP_start_points ,AP_baselines, AP_end_points, AP_storage, APD_average] = apdMap_STUDY(data, start(i), endp(i), ...
                    20, 180, 80, area_coords, Fs, cmap, movie_scrn, handles, SNR_mask,f,b,filename_pdf,s,study);
