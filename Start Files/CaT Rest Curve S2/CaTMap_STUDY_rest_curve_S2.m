function [apdMap1,filtered2,AP_start_points,AP_baselines,AP_end_points,AP_storage, APD_average] = CaTMap_STUDY_rest_curve_S2(data,...
    start, endp,...
    minapd, maxapd,...
    percentAPD,...
    area_coords,...
...
close(gcf)
    ...
    function [end_of_AP] = end_of_AP_calc(AP,AP_baseline,AP_level)
        ...
        [~,max_place] = findpeaks(AP,'MinPeakDistance',50,'MinPeakProminence',0.25);
    ...
    function [start_of_AP] = start_of_AP_calc(AP)
        ...
        [peak, location] =findpeaks(AP,'MinPeakDistance',50,'MinPeakProminence',0.25,'MaxPeakWidth',110);
        if location>50
